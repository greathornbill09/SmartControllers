    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lightSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView,
                ...
                mLightBluetoothService.writeDataToCustomCharacteristic(BluetoothLeService.UUID_AQUA_LIGHT_CHARACTERISTIC,data);
            }
        });
...
// Apply the adapter to the spinner
        ...
        lightScheduleTriggerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                lightScheduleData[0] = (byte) 1;
                Log.w(TAG, "lightScheduleButton "+lightScheduleData[0]);
                updateGlobalSpace("lightmode",lightScheduleData[0]);
    ...
    private void displaySchedule(){
        if((((globalData)activity.getApplication()).getAquaLightChar("lightrecurrences")!= 0)){
            ...
            switch (((globalData)activity.getApplication()).getAquaLightChar("lightrecurrences")){
                case 1:
            ...
            scheduleView.setText("Upcoming Schedule\n" +
                    "Time:"+ Byte.toString(((globalData)activity.getApplication()).getAquaLightChar("lighthours"))+" Hrs "+
                    Byte.toString(((globalData)activity.getApplication()).getAquaLightChar("lightminutes"))+" Min\n"+
                    "Duration:"+ Byte.toString(((globalData)activity.getApplication()).getAquaLightChar("lightdurationhours"))+" Hrs "+
                    Byte.toString(((globalData)activity.getApplication()).getAquaLightChar("lightdurationminutes"))+" Min\n"+
